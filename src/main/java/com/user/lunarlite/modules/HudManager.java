...
import com.user.lunarlite.modules.impl.KeystrokesModule; // Will handle in factory
...
public class HudManager {
    ...
    public static void init() {
        ...
        register(new com.user.lunarlite.modules.impl.CoordsModule());
        register(new com.user.lunarlite.modules.impl.KeystrokesModule());
    ...
    public static void register(HudModule m) {
        modules.add(m);
    }
